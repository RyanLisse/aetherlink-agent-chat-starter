...
- `PASS` — live connector is server-only and restricted to `Agent`, host permission gating, no settings or MCP loading, inline definitions, four turns, and a `$1` budget.
